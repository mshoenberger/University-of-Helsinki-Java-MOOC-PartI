    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command.equals("points")) {
                ...
                String desiredPlayer = reader.nextLine();
                NHLStatistics.searchByPlayer(desiredPlayer);
                ...
                String desiredTeam = reader.nextLine();
                NHLStatistics.sortByPoints();
                NHLStatistics.teamStatistics(desiredTeam);
